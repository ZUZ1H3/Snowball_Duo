...
public class GameClientFrame extends JFrame {
    ...
    public static boolean isChanged, isGameMainScreen, isGameStartScreen, isGameRulesScreen, isGameScreen;  // 게임 규칙 화면 상태
    ...
    public GameScreenPanel gameScreenPane = null;
    ...
    public void selectScreen() {
        if (isGameMainScreen) {
            ...
            isGameScreen = false;
                gameScreenPane = new GameScreenPanel(this, userName);
